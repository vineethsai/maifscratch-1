...
- Cryptographic Provenance: Every agent action is signed and hash-chained
- Task & Step Tracking: Complete audit trail of agent reasoning
...
from demo_app import CrewAIGovernanceDemo


def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(
        description="MAIF + CrewAI Enterprise AI Governance Demo"
    )
    parser.add_argument(
        "--session",
        type=str,
